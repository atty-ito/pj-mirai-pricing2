...
import { num, sizeLabel, colorModeLabel, dpiLabel, metadataLabel, handlingLabel, specProfilePublicLabel, inspectionLabel } from "./formatters";
...
export function buildSpecSections(data: Data): SpecSection[] {
  ...
  const requireMetadata =
    data.specProfile === "gunma" ? data.gunmaMetadataMandatory : data.specProfile === "ndl";
